"""
Django settings for FoodSnap project.
...
SECRET_KEY = 'django-insecure-(pk14_w22wdos-p&sopoldwyubj_60^i7x3bd6iq**-%t^mvwf'
...
# Optional but recommended: enable compression & caching
